      ...
      <div className="grid grid-cols-4 items-center gap-4">
        <div className="col-span-3">
          ...
          <p className="text-stone-800 text-base font-semibold font-['Cairo'] mt-2">
            يمكنك التحويل علي الارقام الاتية
          </p>
          <div className="flex gap-5">
            <div className="flex mt-2 gap-2 items-center">
              ...
              <button
                ...
                onClick={() => navigator.clipboard.writeText("+201080483180")}
              >
                <Copy />
              </button>
            </div>
          </div>
          <ul className="flex flex-col gap-2 mt-4 list-decimal ps-4">
            <li className="text-stone-800 text-base font-semibold font-['Cairo']">
              قم بالتحويل علي الرقم الذي مذكور بالاعلي
            </li>
            <li className="text-stone-800 text-base font-semibold font-['Cairo']">
              قم بكتابة الرقم الخاص بك الذي قمت بالتحويل من خلاله
            </li>
            <li className="text-stone-800 text-base font-semibold font-['Cairo']">
              ارسل صورة من التحويل (Screen Shot)
            </li>
            <li className="text-stone-800 text-base font-semibold font-['Cairo']">
              قم بكتابة المبلغ الذي حولته بالجنية المصري
            </li>
            <li className="text-stone-800 text-base font-semibold font-['Cairo']">
        ...
        <div className="col-span-1">
          <img src={asset("images/vodafone.png")} alt="" className="w-full" />
        </div>
        <div className="col-span-3">
          ...
          <form action="#" onSubmit={submit} className="mt-3 space-y-2">
            ...
            <div className="grid grid-cols-4 items-center gap-x-4 gap-y-2">
              <InputLabel htmlFor="name_en" className="text-right">
                المبلغ الذي حولته بالجنية المصري
              </InputLabel>
              <TextInput
                id="amount"
            ...
            <div className="grid grid-cols-4 items-center gap-x-4 gap-y-2">
              <InputLabel htmlFor="phone_number" className="text-right">
                رقم الخاص بك الذي قمت بالتحويل من خلاله
              </InputLabel>
              <TextInput
                id="phone_number"
                className="col-span-3 !py-2"
                value={data.fields.phone_number}
                placeholder="ادخل رقم الخاص بك"
                onChange={(e) =>
