      ...
      <div className="grid grid-cols-4 items-center gap-4">
        <div className="col-span-3">
          ...
          <div className="flex gap-5">
            <div className="flex mt-2 gap-2 items-center">
              ...
              <button
                ...
                onClick={() => navigator.clipboard.writeText("1506620132")}
              >
                <Copy />
              </button>
            </div>
          ...
          <ul className="flex flex-col gap-2 list-decimal mt-4 ps-4">
            ...
            <li className="text-stone-800 text-base font-semibold font-['Cairo']">
              قم بدخول علي تطبيق Redot Pay وارسل المبلغ الذي تريد تحويله
            </li>
            <li className="text-stone-800 text-base font-semibold font-['Cairo']">
        ...
        <div className="col-span-1">
          <img src={asset("images/redot_pay.png")} alt="" className="w-full" />
        </div>
        <div className="col-span-3">
