      ...
      <div className="grid grid-cols-4 items-center gap-4">
        <div className="col-span-3">
          ...
          <ul className="flex flex-col gap-2 mt-4">
            ...
            <li className="text-stone-800 text-base font-semibold font-['Cairo']">
              عند تحويل عن طريق ccp يرجى ارسال صورة للتحويل
            </li>
            <li className="text-stone-800 text-base font-semibold font-['Cairo']">
        ...
        <div className="col-span-1">
          <img src={asset("images/bank.png")} alt="" className="w-full" />
        </div>
        <div className="col-span-3">
          ...
          <form action="#" onSubmit={submit} className="mt-3 space-y-2">
            ...
            <div className="grid grid-cols-4 items-center gap-x-4 gap-y-2">
              <InputLabel htmlFor="bank_account_name" className="text-right">
                اسم الحساب البنكي الذي قمت بتحويل منه
              </InputLabel>
              <TextInput
                id="bank_account_name"
                className="col-span-3 !py-2"
                value={data.fields.bank_account_name}
