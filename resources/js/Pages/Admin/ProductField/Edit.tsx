...
const Edit = ({
  ...
  const options = JSON.parse(productField.options || "[]");

  const { reset, put, processing, errors, data, setData } = useForm({
    title_en: productField.title_en,
    title_ar: productField.title_ar,
    title_ru: productField.title_ru,
  ...
  const submit: FormEventHandler = (e) => {
    ...
    put(route("admin.product-fields.update", { id: productField.id }));
