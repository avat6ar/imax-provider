...
export const columns: ColumnDef<Category>[] = [
  ...
  },
  {
    ...
    header: "Name Ar",
    cell: ({ row }) => (
      <div className="capitalize">{row.getValue("name_ar")}</div>
    ),
  },
  {
    accessorKey: "name_ru",
    header: "Name Ru",
    cell: ({ row }) => (
      <div className="capitalize">{row.getValue("name_ru")}</div>
    ),
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="flex gap-4 items-center">
        <Link
          href={route("admin.categories.edit", row.getValue("id"))}
          className="cursor-pointer"
        >
          <LucideEdit3 className="text-blue-600 size-5" />
        </Link>
        <Link
          href={route("admin.categories.destroy", row.getValue("id"))}
          method="delete"
          as="button"
          className="cursor-pointer"
        >
...
const Index = ({
  ...
  categories,
  category,
}: PageProps<{ categories: Category[]; category?: Category }>) => {
            ...
            <DialogContent className="sm:max-w-[555px]" dir="ltr">
              <form action="#" onSubmit={submit}>
                ...
                <div className="grid gap-4 py-4">
                  ...
                  <div className="grid grid-cols-4 items-center gap-x-4 gap-y-2">
                    <InputLabel htmlFor="name_ar" className="text-right">
                      Name Arabic
                    </InputLabel>
                    <TextInput
                      id="name_ar"
                  ...
                  <div className="grid grid-cols-4 items-center gap-x-4 gap-y-2">
                    <InputLabel htmlFor="name_ru" className="text-right">
                      Name Russia
                    </InputLabel>
                    <TextInput
                      id="name_ru"
