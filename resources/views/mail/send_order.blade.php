...
<body>
  <div class="container">
    ...
    <div class="contact-info"><strong>@lang('footerMail.email')</strong> {{ env('EMAIL_ADDRESS') }}</div>
    <div class="contact-info"><strong>@lang('footerMail.phone')</strong> {{ env('PHONE_NUMBER') }}</div>
    <hr>
  </div>
</body>
